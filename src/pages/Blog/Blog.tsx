...
import { getPostsPerPage } from './Blog.helpers';
...
export const Blog = () => {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: We only want to run this effect on initial load
  useEffect(() => {
  ...
  }, [context.getState, urlParams.get]);
